...
- [Compliance Evidence Chain Guide](references/compliance-evidence-chain.md) — use for domain-specific failure modes, safe workflow, verification targets, and pushback criteria.
