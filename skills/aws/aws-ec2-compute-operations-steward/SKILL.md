...
- [EC2 Fleet Operations Safety Guide](references/ec2-fleet-operations-safety.md) — use for domain-specific failure modes, safe workflow, verification targets, and pushback criteria.
