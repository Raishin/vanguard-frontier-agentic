...
Use before OCI Database Platform DBA production recommendations, privileged access, cloud mutations, SQL execution, remediation actions, or readiness claims.
