...
Use this reference when live OCI infrastructure data is unavailable, incomplete, denied, or unsafe to query for `oci-devops-container-platform-engineer`.
...
3. Context7 Oracle Cloud Infrastructure documentation (`/websites/oracle_en-us_iaas_content`).
