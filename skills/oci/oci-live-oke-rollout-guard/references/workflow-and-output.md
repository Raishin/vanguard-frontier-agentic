...
Use this workflow for full reviews, routing decisions, and live-guard decisions.
...
Return these fields when the user asks for a review, guardrail, route, or production-readiness answer:

- `verdict`: pass, pass-with-risk, blocked, needs-evidence, or routed.
- `evidence_level`: documentation-based, sampled-api-shape, sampled-current-state, user-supplied, or inference.
- `blockers`: missing proof, unsafe assumptions, approval gaps, or routing gaps.
