...
Use this checklist before producing guidance, requesting evidence, routing a task, or proposing changes.
...
Require explicit approval before creating, updating, deleting, moving, scaling, rotating, patching, enabling, disabling, deploying, applying, destroying, promoting, rolling back, deleting keys, changing traffic, changing access, or changing production state.
