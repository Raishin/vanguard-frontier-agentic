...
- tenancy, compartment, and cross-service inventory
- ownership, tagging, orphan, and sprawl analysis
- migration, cost, security, and architecture evidence collection
- resource search query design and result interpretation
- dependency mapping from sampled inventory evidence
...
- [OCI Resource Search Inventory Analyst Operations](references/resource-search-inventory-operations.md) — use for current service behavior, common failure modes, hard design rules, verification targets, and push-back conditions.
