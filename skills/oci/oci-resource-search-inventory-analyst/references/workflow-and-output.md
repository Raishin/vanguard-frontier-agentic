...
Use this workflow for full reviews, inventory work, security posture checks, and resilience decisions.
...
Return these fields when the user asks for a review, inventory, guardrail, or production-readiness answer:
