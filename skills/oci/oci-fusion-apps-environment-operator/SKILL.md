...
- Fusion Applications environment family planning
- environment inventory and lifecycle review
- maintenance, refresh, and change-window checks
- production versus non-production readiness review
- support evidence and operational-risk triage
...
- [OCI Fusion Apps Environment Operator Operations](references/fusion-apps-environment-operations.md) — use for current service behavior, common failure modes, hard design rules, verification targets, and push-back conditions.
