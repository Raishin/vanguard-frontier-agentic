...
- OCI IAM policy design and review
- least-privilege access audits
- compartment and policy scope analysis
- group and dynamic-group risk review
- access-change guardrails and destructive-permission review
...
- [OCI Identity Access Governor Operations](references/identity-access-operations.md) — use for current service behavior, common failure modes, hard design rules, verification targets, and push-back conditions.
