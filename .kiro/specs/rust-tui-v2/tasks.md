...
- [ ] 1. Foundation — Project restructuring and core types
  - [ ] 1.1 Restructure Cargo.toml and create module skeleton
  ...
  - [ ] 1.2 Define error types hierarchy
  ...
  - [ ] 1.3 Implement security module (enhanced from v1)
  ...
  - [ ]* 1.4 Write property tests for security module
  ...
  - [ ]* 1.6 Write unit tests for data model serialization
...
- [ ] 3. Infrastructure — SQLite and filesystem watching
  - [ ] 3.1 Implement SQLite index manager
  ...
  - [ ] 3.2 Implement audit log with hash chain
  ...
  - [ ]* 3.3 Write property tests for audit hash chain
    - **Property 25: Audit log hash chain integrity**
    - **Validates: Requirements 14.8**

  - [ ] 3.4 Implement filesystem watcher integration
  ...
  - [ ] 3.5 Implement workspace detection (enhanced from v1)
...
- [ ] 4. Checkpoint — Infrastructure complete
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 5. Core Domain — Catalog, registry, scanner
  - [ ] 5.1 Enhance catalog store with reload and content hashing
  ...
  - [ ]* 5.2 Write property tests for catalog store
  ...
  - [ ] 5.3 Implement workspace registry TOML parser
  ...
  - [ ]* 5.4 Write property tests for workspace registry
  ...
  - [ ] 5.5 Implement workspace scanner with multi-strategy detection
  ...
  - [ ]* 5.6 Write property tests for workspace scanner
...
- [ ] 7. Engines — Coverage, drift, versions, policy, gates, dependencies
  - [ ] 7.1 Implement coverage engine
  ...
  - [ ]* 7.2 Write property tests for coverage engine
  ...
  - [ ] 7.3 Implement drift detection engine
  ...
  - [ ]* 7.4 Write property tests for drift detection
    - **Property 21: Drift classification**
    - **Validates: Requirements 10.3, 10.4**

  - [ ] 7.5 Implement version comparison engine
  ...
  - [ ]* 7.6 Write property tests for version comparison
    - **Property 20: Semantic version comparison**
    - **Validates: Requirements 8.1, 8.6, 9.1**

  - [ ] 7.7 Implement policy engine
  ...
  - [ ] 7.8 Implement trust boundary enforcement
  ...
  - [ ] 7.9 Implement lifecycle gate evaluation
  ...
  - [ ] 7.10 Implement violations aggregation
  ...
  - [ ]* 7.11 Write property tests for policy engine
  ...
  - [ ] 7.12 Implement dependency graph builder
  ...
  - [ ]* 7.13 Write property tests for dependency graph
  ...
  - [ ] 7.14 Implement gate DAG executor
  ...
  - [ ]* 7.15 Write property tests for gate DAG
  ...
  - [ ] 7.16 Implement asset integrity verification
  ...
  - [ ]* 7.17 Write property tests for integrity verification
    - **Property 14: SHA-256 integrity verification**
    - **Validates: Requirements 4.1, 4.2, 4.6**

- [ ] 8. Checkpoint — Engines complete
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 9. Presentation — TUI and headless
  - [ ] 9.1 Implement event loop architecture
  ...
  - [ ]* 9.2 Write property test for event coalescing
    - **Property 30: Event coalescing**
    - **Validates: Requirements 34.5, 1.6**

  - [ ] 9.3 Implement TUI navigation state machine
  ...
  - [ ]* 9.4 Write property test for tab cycling
    - **Property 33: Tab cycling**
    - **Validates: Requirements 16.3**

  - [ ] 9.5 Implement TUI widgets
  ...
  - [ ] 9.6 Implement fuzzy search with nucleo-matcher
  ...
  - [ ] 9.7 Implement headless reporter
  ...
  - [ ]* 9.8 Write property tests for headless reporter
  ...
  - [ ] 9.9 Implement CLI interface with clap derive
  ...
  - [ ]* 9.10 Write unit tests for CLI parsing
...
- [ ] 10. Checkpoint — Presentation complete
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 11. Integration — Wire everything together
  - [ ] 11.1 Implement main.rs entry point and mode dispatch
  ...
  - [ ] 11.2 Implement headless mode end-to-end pipeline
  ...
  - [ ] 11.3 Implement TUI mode end-to-end rendering
  ...
  - [ ] 11.4 Implement accessibility features
  ...
  - [ ] 11.5 Implement cross-platform path handling
...
- [ ] 13. Testing and fixtures
  ...
  - [ ]* 13.3 Write integration tests for workspace scanning
  ...
  - [ ]* 13.4 Write integration tests for policy evaluation
  ...
  - [ ]* 13.5 Write integration tests for headless reports
  ...
  - [ ]* 13.6 Write integration tests for SQLite persistence
  ...
  - [ ]* 13.7 Write remaining property tests
