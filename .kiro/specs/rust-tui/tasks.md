...
- [x] 3. Workspace detection and catalog loading
  ...
  - [x] 3.2 Write property test for workspace detection
    - **Property 16: Workspace detection finds correct root**
    - **Validates: Requirements 14.2, 15.1**

  - [x] 3.3 Implement catalog loader with strict deserialization
...
- [x] 4. Security module
  ...
  - [x] 4.2 Write property tests for sanitization
  ...
  - [x] 4.6 Write property tests for redaction
...
- [x] 6. Search engine and catalog queries
  - [x] 6.1 Implement fuzzy search with nucleo-matcher
  ...
  - [x] 6.4 Write property test for reverse-lookup
    - **Property 5: Reverse-lookup returns correct associated agents**
    - **Validates: Requirements 2.2**

- [x] 7. Subprocess execution
  - [x] 7.1 Implement subprocess executor with tokio
  ...
  - [x] 7.3 Write property test for export command construction
    - **Property 6: Export command argument construction**
    - **Validates: Requirements 7.2, 20.2**

- [x] 8. Audit logging
  - [x] 8.1 Implement structured logging with tracing
...
- [x] 10. UI layer — terminal management and layout
  - [x] 10.1 Implement terminal manager
  ...
  - [x] 10.2 Implement navigation state machine
  ...
  - [x] 10.3 Implement layout computation and theme
  ...
  - [x] 10.5 Write property test for agent detail formatter
    - **Property 4: Agent detail formatter includes all required fields**
    - **Validates: Requirements 1.4**

- [x] 11. Application event loop and wiring
  - [x] 11.1 Implement application state and event loop
  ...
  - [x] 11.3 Implement validation gate controller
  ...
  - [x] 11.4 Implement export command builder controller
  ...
  - [x] 11.5 Implement integrity view controller
...
- [x] 13. Integration tests and test fixtures
  - [x] 13.1 Create test fixtures
  ...
  - [x] 13.3 Write integration tests for subprocess execution
  ...
  - [x] 13.4 Write integration tests for search
  ...
  - [x] 13.5 Write property test for deterministic rendering
    - **Property 17: Deterministic rendering**
    - **Validates: Requirements 18.1**

- [x] 14. CI workflow and documentation
  - [x] 14.1 Create CI workflow configuration
  ...
  - [x] 14.2 Create README and project documentation
