...
description: "Curated Finance agents for finance variance analysis advisor, finance treasury liquidity advisor. Routes via finance-maestro-agent to specialist agents based on task scope. Static review only; no live mutations."
keywords: ["finance", "static-review", "configuration-audit", "best-practices"]
author: "Raishin"
---
# Vanguard Frontier — Finance

Curated Finance agents for finance variance analysis advisor, finance treasury liquidity advisor. Routes via finance-maestro-agent to specialist agents based on task scope. Static review only; no live mutations.
...
Agent specs and adapters are part of the [Vanguard Frontier Agentic](https://github.com/Raishin/vanguard-frontier-agentic) marketplace. For this provider, see `agents/finance/` in that repository. All 3 agents in this provider ship a Kiro adapter (`harnesses/kiro-ide.agent.md`, `kiro-cli.agent.json`).
