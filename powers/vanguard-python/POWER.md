...
description: "Curated Python agents for python application security, python async concurrency reliability, python numerical scientific correctness, python packaging supply chain. Routes via python-maestro-agent to specialist agents based on task scope. Static review only; no live mutations."
keywords: ["python", "asyncio", "pyproject", "dependency-confusion", "static-review"]
author: "Raishin"
---
# Vanguard Frontier — Python

Curated Python agents for python application security, python async concurrency reliability, python numerical scientific correctness, python packaging supply chain. Routes via python-maestro-agent to specialist agents based on task scope. Static review only; no live mutations.
...
Agent specs and adapters are part of the [Vanguard Frontier Agentic](https://github.com/Raishin/vanguard-frontier-agentic) marketplace. For this provider, see `agents/python/` in that repository. All 5 agents in this provider ship a Kiro adapter (`harnesses/kiro-ide.agent.md`, `kiro-cli.agent.json`).
