...
## 🛡️ Refusal-by-Default Safety Model

The system refuses to act when:

1. 🛡️ **Unknown intent** - Maestro cannot route to a specialist
2. 🛡️ **Out-of-scope request** - Agent does not have a skill for the request
