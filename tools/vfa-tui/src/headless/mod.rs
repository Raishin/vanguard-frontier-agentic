...
pub use formats::{
    format_json, format_markdown, format_table, sort_by_id, with_status, ReportData, STATUS_DRIFT,
    STATUS_FAIL, STATUS_MISSING, STATUS_PASS, STATUS_STALE, STATUS_WARN,
};
