## EVAL REPORT: cloud-agents-reference-quality-oci-agents-004
...
- Items:
  - agents/oci/oci-migration-cutover-architect-agent
  - agents/oci/oci-multi-cloud-architect-agent
  - agents/oci/oci-mysql-heatwave-ai-specialist-agent
  - agents/oci/oci-network-architect-agent
  - agents/oci/oci-observability-incident-responder-agent

### Evidence used
- Documentation-based: official OCI docs for Cloud Migrations and disaster recovery planning, multicloud/database connectivity, MySQL HeatWave backups/high availability/features, VCN/DRG/FastConnect networking, and Monitoring/Connector Hub/APM observability.
...
### Capability Evals
- stale-connector-label-guidance-removed: PASS - targeted grep found no exact stale phrases in batch 4: `ask only for the configured MCP server name`, `hard-coded MCP server name`, `MCP server name`, `configured server name`.
