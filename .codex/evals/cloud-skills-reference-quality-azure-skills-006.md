## EVAL DEFINITION: cloud-skills-reference-quality-azure-skills-006
...
- No tenant, subscription, resource, RBAC assignment, private endpoint, deployment pipeline, DR posture, or health event state is proven without sampled read-only evidence.
...
- [ ] Existing stale phrasing that mentions generic live/Microsoft evidence or Azure-specific MCP tooling is replaced with the approved generic documentation phrasing.
- [ ] Metadata official_docs contain first-party Microsoft Learn URLs and no generic tool documentation URLs.
...
- [x] Existing stale phrasing that mentions generic live/Microsoft evidence or Azure-specific MCP tooling is replaced with the approved generic documentation phrasing.
- [x] Metadata official_docs contain first-party Microsoft Learn URLs and no generic tool documentation URLs.
...
### Validation commands
- Structural Python grader for batch 006
...
### Verdict
Pass. Batch 006 is validated and remains uncommitted.
