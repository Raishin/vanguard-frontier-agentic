...
> Agent for `aws-change-impact-advisor`. Assess planned AWS change impact, blast radius, rollback readiness, stakeholder communication, and non-destructive go/no-go guidance before execution.
