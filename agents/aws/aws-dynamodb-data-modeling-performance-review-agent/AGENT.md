...
> Agent for `aws-dynamodb-data-modeling-performance-review`. Review DynamoDB table design, partition keys, sort keys, GSIs/LSIs, hot partitions, query/scan patterns, capacity, global tables, TTL, DAX, and cost/performance tradeoffs.
...
Use this canonical agent only for `aws-dynamodb-data-modeling-performance-review` work.
