...
> Agent for `huawei-dws-dli-data-analyst`. Operate DWS (Data Warehouse Service / GaussDB DWS), DLI (Data Lake Insight / serverless Spark+Flink), MRS (MapReduce Service), and DataArts Studio for data pipelines and warehouse workloads.
...
Use this canonical agent only for `huawei-dws-dli-data-analyst` work.
