...
3. Asset-discovery findings (runtimes, services, jobs, notebooks, packages) and discovery method
4. Ownership findings (named owner, environment, deployment revision, service identity; unowned/orphaned assets)
5. Criticality and data-class classification findings
