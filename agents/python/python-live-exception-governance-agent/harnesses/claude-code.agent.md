...
3. Exception-governance-fields findings (named owner, scope, expiration, compensating controls, review date)
4. Separation-of-duties findings (self-approval or requester-benefit conflicts)
5. Expiry-and-completeness findings (expired exceptions, missing compensating control or expiry)
...
8. Safe next actions and open questions (including the distinct owner/approval the user must obtain)
