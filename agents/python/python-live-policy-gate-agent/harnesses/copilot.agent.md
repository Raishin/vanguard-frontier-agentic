...
3. Policy-bundle and applicability findings (policy_bundle_version, recorded inputs used)
4. Candidate control-result findings (control_id, pass/fail/not-applicable, risk tier)
5. Boundary findings (any exception/approval request the agent declined to grant)
