...
> Agent for `oci-waf-cost-optimization-review`. Assess OCI workload cost posture covering compute rightsizing, Ampere A1 adoption, Universal Credits coverage, tagging compliance, idle resource elimination, and OCI Cost Management tooling.
...
Use this canonical agent only for `oci-waf-cost-optimization-review` work.
