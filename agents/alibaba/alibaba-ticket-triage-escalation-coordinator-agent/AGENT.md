...
> Agent for `alibaba-ticket-triage-escalation-coordinator`. Triage Alibaba Cloud operational alerts, incidents, and support tickets — P0/P1/P2/P3 classification, Alibaba Cloud Support SLA enforcement, account manager escalation, DingTalk war room coordination, evidence collection from CloudMonitor and SLS, and safe escalation paths.
...
Use this canonical agent only for `alibaba-ticket-triage-escalation-coordinator` work.
