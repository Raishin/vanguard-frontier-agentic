...
> Agent for `alibaba-kms-secret-lifecycle-steward`. Audit and govern Alibaba Cloud KMS key lifecycles, Certificate Manager, SSM (Secrets Manager), and HSM key operations. Ensure encryption-at-rest coverage and rotation compliance.
...
Use this canonical agent only for `alibaba-kms-secret-lifecycle-steward` work.
