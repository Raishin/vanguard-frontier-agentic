...
> Agent for `alibaba-ecs-compute-operator`. Manage ECS instance lifecycle, Auto Scaling group configuration and health, ECI serverless container instances, Cloud Assistant O&M command execution, and Deployment Set placement rules.
...
Use this canonical agent only for `alibaba-ecs-compute-operator` work.
