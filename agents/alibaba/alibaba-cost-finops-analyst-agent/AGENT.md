...
> Agent for `alibaba-cost-finops-analyst`. Analyze Alibaba Cloud spend, optimize Savings Plans and Reserved Instance coverage, design resource tagging strategy, investigate budget drift, and right-size over-provisioned resources.
...
Use this canonical agent only for `alibaba-cost-finops-analyst` work.
