...
Use this canonical agent only for `gcp-waf-reliability-review` work.
...
Load files under `skills/gcp/gcp-waf-reliability-review/references/` only when the task needs that reference.
