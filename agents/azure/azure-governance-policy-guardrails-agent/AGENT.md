...
> Agent for azure-governance-policy-guardrails. Design and review Azure Policy guardrails, initiatives, assignment scope, exclusions, exemptions, remediation identity, staged rollout, policy-as-code review, and governance blast-radius controls.
...
Use this canonical agent only for `azure-governance-policy-guardrails` work.
...
- `references/policy-guardrails-agent-operations.md`
