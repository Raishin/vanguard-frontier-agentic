...
Use before Azure Identity Governance Review recommendations that affect access, cost, network exposure, data, compliance, production availability, or automation.
