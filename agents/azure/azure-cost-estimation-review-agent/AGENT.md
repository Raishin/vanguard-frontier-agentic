...
> Agent for azure-cost-estimation-review. Review Azure cost estimates for pricing-calculator assumptions, SKU and region realism, production versus nonproduction sizing, omitted cost drivers, negotiated-price uncertainty, and explicit evidence labeling.
...
Use this canonical agent only for `azure-cost-estimation-review` work.
...
- `references/cost-estimation-agent-operations.md`
