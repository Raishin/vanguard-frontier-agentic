...
> Agent for azure-aks-platform-operator. Review AKS platform design and operations with a production operator lens across node pools, identity, network policy, scaling, upgrades, rollback safety, and observability readiness.
...
Use this canonical agent only for `azure-aks-platform-operator` work.
...
- `references/aks-platform-agent-operations.md`
