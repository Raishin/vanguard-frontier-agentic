...
Use before Azure Key Vault Secret Lifecycle Auditor recommendations that affect access, cost, network exposure, data, compliance, production availability, or automation.
