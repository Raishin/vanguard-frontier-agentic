...
> Agent for `svelte-sveltekit-specialist`. Static-review agent for SvelteKit routing/load-function correctness and progressive-enhancement (`use:enhance`, form actions) resilience.
...
Use this canonical agent only for `svelte-sveltekit-specialist` work: SvelteKit route/load-function boundary correctness and progressive-enhancement (`use:enhance`, form actions) review.
